...
// using Cascade;
// using Cascade.Test;
// using CivtracDispatch.Common;
// using CivtracDispatch.Common.Cascade;
// using NUnit.Framework;
// using Serilog;
// using StandardExceptions;
//
// namespace CivtracDispatch.Test {
//
// 	[TestFixture]
// 	public class CivtracOfflineTests {
// 		private string tempDir;
// 		MockOrigin2 origin;
// 		MockModelClassOrigin<Docket> docketOrigin;
// 		MockModelClassOrigin<DocketItem> docketItemOrigin;
// 		MockModelClassOrigin<DocketReceipt> docketReceiptOrigin;
// 		MockModelClassOrigin<DocketReceiptItem> docketReceiptItemOrigin;
// 		
// 		CascadeDataLayer cascade;
// 		private ModelCache modelCache;
//
...
// 				Directory.CreateDirectory(tempDir);
// 			
// 			var cascadeConfig = new CascadeConfig() {
// 				StoragePath = Path.Combine(tempDir, "CascadeStorage")
// 			};
// 			
// 			// docketOrigin = new MockModelClassOrigin<Docket>();
// 			// docketItemOrigin = new MockModelClassOrigin<DocketItem>();
// 			// docketReceiptOrigin = new MockModelClassOrigin<DocketReceipt>();
// 			// docketReceiptItemOrigin = new MockModelClassOrigin<DocketReceiptItem>();
// 			// origin = new MockOrigin2(
// 			// 	new Dictionary<Type, IModelClassOrigin>() {
// 			// 		{ typeof(Docket), docketOrigin },
// 			// 		{ typeof(DocketItem), docketItemOrigin },
// 			// 		{ typeof(DocketReceipt), docketReceiptOrigin },
// 			// 		{ typeof(DocketReceiptItem), docketReceiptItemOrigin }
// 			// 	},
// 			// 	1000
// 			// );
// 			modelCache = BuildCivtracCascade.BuildModelCache();
// 			fileCache = BuildCivtracCascade.BuildFileSystemCache(cascadeConfig.FileCachePath);
// 			
// 			cascade = new CascadeDataLayer(
// 				origin, 
...
// 			);
// 			// AppCommon.Setup();
// 			// AppCommon.Register<ICivmecPlatform>(new MockCivmecPlatform());
// 			// AppCommon.Register(cascade);
// 		}
//
// 		[TearDown]
// 		public void TearDown() {
