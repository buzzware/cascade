    ...
    public static class TypeExtensions
    {
        ...
        public static IEnumerable<PropertyInfo> GetPropertiesWithAttribute<T>(this Type type, bool inherit = true) where T : Attribute
        {
            ...
            return type.GetRuntimeProperties()
                .Where(prop => prop.IsDefined(typeof(T)) && (prop.DeclaringType == type || inherit));
        }
        ...
        public static Dictionary<T, PropertyInfo> GetAttributeToPropertyMapping<T>(this Type type, bool inherit = true) where T : Attribute
        {
            ...
            var result = new Dictionary<T, PropertyInfo>(properties.Count());
        ...
        {
            var result = type.GetTypeInfo().GetCustomAttributes(typeof(T), inherit);
        ...
        public static bool IsSimpleType(this Type type)
        {
            ...
            return Array.IndexOf(SimpleTypes, type) > -1 || type.GetTypeInfo().IsEnum;
        }
